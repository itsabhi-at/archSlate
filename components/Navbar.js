...
function Navbar() {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="MOBILE-NAV relative h-screen overflow-y-hidden">
        <main className="flex md:hidden justify-between items-center px-8 py-2 shadow-md">
          <div className=" flex gap-4">
            <Image src={logo} alt="logo" className="object-contain" />
            <p className=" font-semibold font-lora text-[32px]">Archslate</p>
          </div>
          <ul
            className={`flex  flex-col absolute right-0 top-0 font-bold text-[16px] translate-x-full gap-8 text-black font-noto h-screen bg-orange-400 bg-opacity-75 w-full mt-16 pt-8  transition-all
              ${menu ? "translate-x-0" : "translate-x-full"} `}
          >
            <li className="flex flex-row gap-4 justify-start items-center cursor-pointer pl-8">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
