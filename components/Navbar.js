...
function Navbar() {
  ...
  return (
    <div className="bg-white relative z-20 overflow-x-visible">
      ...
      <div className="fixed top-0 w-full l-0 bg-white">
        <main
          className={`MOBILE-NAV relative flex md:hidden justify-between items-center px-8 py-2 shadow-md ${
            menu ? "overflow-x-hidden" : "overflow-x-visible"
          } `}
        >
          <Link href={"/"}>
            <div className=" flex gap-4">
