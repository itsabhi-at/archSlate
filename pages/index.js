      ...
      <div className="flex justify-between items-center pt-4 pb-16 ">
        <div className="flex gap-4 items-center relative">
          <div className="relative flex items-center">
            ...
            <select
              id="type"
              className=" bg-gray-50 border-black text-gray-900 font-bold  rounded-full focus:ring-black focus:border-black block w-[130px] px-4 pr-2 pl-8  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:orange-black dark:focus:border-black"
            >
