      ...
      <main className="container mx-auto lg:px-36 pt-8">
        ...
        <section className="grid grid-cols-4 gap-8 mb-4">
          ...
          <div className="CARD-THREE bg-white rounded-md p-4 min-h-[200px]">
            ...
            <div className=" text-center  text-2xl font-light font-light ">
              $55-$65/hour
            </div>
          </div>
        ...
        <section className="grid grid-cols-4 gap-8 mb-4 font-roboto">
          <div class="col-span-3 py-4 px-8 bg-white rounded-md mb-4 ">
            {/* desc part here  */}
            <div>
            ...
            <div className="flex gap-4 justify-between items-center">
              ...
              <button className="flex gap-2  bg-black  text-white text-xl px-3 py-2 rounded-full font-semibold text-center">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <button className="flex gap-2 bg-black  text-white text-xl px-4 py-2 rounded-full font-semibold text-center">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
